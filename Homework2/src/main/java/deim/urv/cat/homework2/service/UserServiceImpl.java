...
public class UserServiceImpl implements UserService {
    ...
    public User validateUser(String username, String password) {
        try {
            ...
            // CORRECCION: Usamos el endpoint específico para buscar por username
            // webTarget base es ".../customer"
            // Añadimos ".path("username").path(username)" para generar ".../customer/username/{username}"
